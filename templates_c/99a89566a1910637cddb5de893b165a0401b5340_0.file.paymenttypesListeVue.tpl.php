...
function content_673481987b44f9_50511702 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<!--[if lt IE 7]>
                            ...
                            <div class="card-header">
                                <strong class="card-title">
                                    ...
                                    <form class="pos-ajout" method="POST" action="index.php">
                                        ...
                                        <label>Ajouter un type de paiement : <input id="aImage" type="image"
                                                name="btn_ajouter" src='public/images/icones/a16.png'></label>
                                    </form>
                                </strong>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td class="pos-actions">
                                                    <form method="POST" action="index.php">
                                                        ...
                                                        <input type="hidden" name="Payment"
                                                            value="<?php echo $_smarty_tpl->tpl_vars['paymenttype']->value->getPayment();?>
">
...
">
                                                        <input type="image" src="public/images/icones/m16.png" name="modifier">
                                                    </form>
                                                </td>
                                                <td class="pos-actions">
                                                    <form method="POST" action="index.php">
